...
class KeyBoard:
    def __init__(self):
        ...
        self.pub = rospy.Publisher('/vesc/high_level/ackermann_cmd_mux/input/nav_0', AckermannDriveStamped) # Publish to /vesc/high_level/ackermann_cmd_mux/input/nav_0
